      ...
      <div className="mx-auto w-full max-w-7xl px-6 py-12 sm:px-8 sm:py-16 md:px-10 md:py-20 lg:px-12 lg:py-36">
        <div className="grid items-center gap-12 lg:grid-cols-12 lg:gap-16">
          ...
          <div className="lg:col-span-7 lg:pt-[60px]">
            ...
            <p className="relative z-10 mt-8 max-w-2xl font-body text-base font-medium leading-relaxed text-silver/90 sm:mt-9 sm:text-lg md:mt-9 md:text-xl lg:mt-10 lg:text-2xl">
              I'm a{" "}
            ...
            <div className="mt-10 flex flex-wrap gap-3 sm:mt-10 sm:gap-4 md:mt-10 lg:mt-11">
              <a
                href="#projects"
                className="relative z-10 inline-flex cursor-pointer items-center gap-2 bg-silver px-5 py-3 font-code text-xs font-bold uppercase tracking-widest text-surface transition-colors hover:bg-accent hover:text-accent-foreground sm:px-7 sm:py-3.5 sm:text-sm"
              >
              ...
              <a
                ...
                className="relative z-10 inline-flex w-40 cursor-pointer items-center gap-2 hero-gradient border border-accent px-5 py-3 font-display text-xs font-bold uppercase tracking-widest text-accent transition-colors hover:border-accent hover:text-accent sm:w-auto sm:px-7 sm:py-3.5 sm:text-sm lg:border-border/60 lg:text-silver"
              >
